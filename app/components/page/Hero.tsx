      ...
      <div className="flex">
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          <div className="px-6 py-5 bg-white rounded text-center font-bold">
            ...
            <p className="font-thin font-oswald text-lg">JOURS</p>
          </div>
          <div className="px-6 py-5 bg-white rounded text-center font-bold">
            <h1 className="text-3xl font-oswald">{item.hours}</h1>
            <p className="font-thin font-oswald text-lg">HEURES</p>
          </div>
          <div className="px-6 py-5 bg-white rounded text-center font-bold">
          ...
          <div className="px-6 py-5 bg-white rounded text-center font-bold">
            ...
            <p className="font-thin font-oswald text-lg">SECONDES</p>
          </div>
        </div>
      </div>
